    ...
    <div class="container">
        ...
        <div class="card" id="tab-instruments" style="display:none;">
            ...
            <div class="piano-buttons" style="margin-top:10px;">
                ...
                <button class="btn btn-sm" onclick="pianoClearSequence()">✕ Clear</button>
